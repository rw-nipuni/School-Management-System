...
public class StudentRecord extends javax.swing.JFrame {
    ...
    private void Get_Data(){
        String sql = "select StudentID , FirstName,LastName,DateOfBirth,GuardianName,GuardianNIC,GuardianMobile,Address,DateOfAdmission,lastSchoolAttended,Gender,AdmissionInClass,ExamNumber,LastClassAttended from StudentRecord";
        try{
    ...
    private void initComponents() {
        ...
        teacherRecord.setBackground(new java.awt.Color(0, 153, 204));
    ...
    private void dataTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableMouseClicked
        try{
            ...
            if(rs.next()){
                ...
                student.GuardianNameField.setText(add5);
                String add6 = rs.getString("GuardianNIC");
                student.GuardianNICField.setText(add6);
                String add7 = rs.getString("GuardianMobile");
                student.GuardianMobileField.setText(add7);
                String add8 = rs.getString("Address");
                student.addressField.setText(add8);
                String add9 = rs.getString("DateOfAdmission");
                student.DateOfAdmissionField.setText(add9);
                String add10 = rs.getString("lastClassAttended");
                student.lastClassAttendedField.setText(add10);
                String add11 = rs.getString("lastSchoolAttended");
                student.lastSchoolAttendedField.setText(add11);
                String add12 = rs.getString("Gender");
                student.cmbGender.setSelectedItem(add12);
                String add13 = rs.getString("AdmissionInClass");
                student.AdmissionInClassField.setText(add13);
                String add14 = rs.getString("ExamNumber");
                student.ExamNumberField.setText(add14);
